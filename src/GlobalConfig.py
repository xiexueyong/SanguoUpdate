...
if branch=='allp':
    ...
    debug = False;
    #版本tag集合
    alltags = ['v2.0.0b','v2.0.1b','v2.0.2b','v2.0.3b','v2.0.4b','v2.0.5b','v2.0.6b','v2.0.7b','v2.0.8b']
    #所有的渠道名
    ...
    72,73,74,75,76,77,78,79,80,81,82,85,86,87,89,90,91,92,93,98,99,100]
    useRelation = {'lovegame':whoUseLovegame,'ali':whoUseAli,'chinamobile':whoUseChinamobile,'xiaomi':whoUseXiaomi,'putaogame':whoUsePutao,'letv':whoUseLetv,'dangbei':whoUseDangbei,'atet':whoUseAtet,'phone':whoUsePhone}
    #idHead从1或者100000开始，防止在本次更新期间有玩家升级上次的小更新。
    idHead = 52300#上次是1438
    ...
    debug = False;
    #版本tag集合
    alltags = ['v1.5.0b','v1.5.1b','v1.5.2b','v1.5.3b','v1.5.4b','v1.5.7b','v1.5.8b','v1.5.10b','v1.5.11b','v1.5.12b','v1.5.13b','v1.5.14b','v1.5.15b','v1.5.16b','v1.5.17b','v1.5.18b','v1.5.19b','v1.5.20b','v1.5.21b','v1.5.22b','v1.5.25b','v1.5.26b','v1.5.27b','v1.5.29b','v1.5.30b','v1.5.31b','v1.5.32b','v1.5.33b','v1.5.34b','v1.5.35b']
    #所有的渠道名
