...
debug = True;
#版本tag集合
alltags = ['v1.5.6d','v1.5.7d','v1.5.8d','v1.5.9d','v1.5.10d','v1.5.11d','v1.5.12d','v1.5.13d']
#所有的渠道名
...
#存储所有的使用关系
useRelation = {'ali':whoUseAli,'chinamobile':whoUseChinamobile,'xiaomi':whoUseXiaomi,'putaogame':whoUsePutao,'letv':whoUseLetv}
